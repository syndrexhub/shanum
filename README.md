...
* lalu update cert
```html
wget https://raw.githubusercontent.com/wisnucokrosatrio/wisnucokrosatrio/master/xray/certv2ray.sh && chmod +x certv2ray.sh && bash certv2ray.sh
 ```
* atau
```html
certv2ray
...
• Stunnel5                : 500, 600, 700

• OpenVPN                 : TCP 1194, UDP 1195, SSL 990
...
• Shadowsocks-R           : 1444-1943

• SS-OBFS TLS             : 2444-2943

• SS-OBFS HTTP            : 2944-3442

• XRAYS Vmess TLS         : 2053
